...
/*
 * `/v1/push/*` — Web Push 구독 (#606 · ssccops#446 «API 계약» · ADR-0045 · #671).
 *
 ...
 * 부르므로 `browser-client.ts`를 타고, `DELETE`는 다른 삭제와 같이 `data` 없는 200 봉투라 `Nullable`
 * 통로가 따로 필요하다. 401·403은 훅이 `error`로 올리고 스위치는 꺼진 채 남는다.
 */
