 ...
 *
 * 본문(페이지 `academic`)은 홍보국이 쓰고, 이 블록은 코드가 붙인다 — 주소가 배포 설정
 * (`NEXT_PUBLIC_LMS_ORIGIN`)에서 오는 값이라 글 안에 적게 하면 환경마다 갈린다. 설정이 없으면
 * 블록을 그리지 않는다(없는 주소로 보내지 않는다 — `/me`의 학술 카드와 같은 판단).
 *
