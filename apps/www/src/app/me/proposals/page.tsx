...
import { MeProposalsPage } from "@/views/me";

/**
 * 낸 기획안 — 내 활동의 내부 페이지 (#574 · ssccops#428). 허브 `/me`와 같은 이유로 색인하지
...
export default async function Page({ searchParams }: Readonly<PageProps<"/me/proposals">>) {
  ...
  return <MeProposalsPage status={status} />;
}
