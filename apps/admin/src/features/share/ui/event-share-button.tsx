...
function noticeOf(
  ...
  if (eventSttsCd === "ARCHIVED") {
    return hasLink
      ? "보관된 행사는 새로 공유할 수 없습니다. 남아 있는 링크는 중지할 수 있습니다."
  ...
  if (eventSttsCd === "PUBLISHED") {
    ...
    return hasLink
      ? "게시된 행사는 공개 주소로 공유합니다. 게시 전에 만든 링크도 아직 열립니다."
      : "게시된 행사는 공개 주소로 공유합니다.";
  }

  return hasLink
    ? "게시 전 링크를 공유 중입니다. 받은 사람에게는 제목과 요약만 보입니다."
    : "게시 전에는 공유 링크로 나갑니다. 받은 사람에게는 제목과 요약만 보입니다.";
}
