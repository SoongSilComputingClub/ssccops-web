...
import { type NavGroup, type NavItem } from "./nav";
 ...
 * 추가»·테마가 이 아래 발치에 있었는데 전부 계정 메뉴(`@ssccops/ui` `AccountMenu` — 사이드바 발치 ·
 * 드로어는 `AccountSections`)로 들어갔다. 스크롤 상자는 부르는 쪽이 두른다 — 사이드바는 목차만
 * 스크롤하고 발치를 고정하지만, 드로어는 목차와 계정 절이 함께 스크롤된다.
 */
